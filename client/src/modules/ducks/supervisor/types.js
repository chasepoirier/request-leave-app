export const REQUEST_ADD_USER = '@@supervisor/REQUEST_ADD_USER'
export const ADD_USER_SUCCESS = '@@supervisor/ADD_USER_SUCCESS'
export const ADD_USER_FAIL = '@@supervisor/ADD_USER_FAIL'
...
export const SET_APPROVAL_STATUS_REQUEST =
  '@@supervisor/SET_APPROVAL_STATUS_REQUEST'
